...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={sectionRef} className="relative flex-1 flex items-center py-20 md:py-32 px-6">
      {/* Ambient glow */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] rounded-full bg-blue-500/5 blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-4xl mx-auto text-center w-full">
        ...
        <div className="reveal opacity-0 transition-all duration-700 translate-y-8 [&.animate-in]:opacity-100 [&.animate-in]:translate-y-0 mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mt-4">Get In Touch</h2>
        </div>

        <p className="reveal opacity-0 transition-all duration-700 delay-200 translate-y-8 [&.animate-in]:opacity-100 [&.animate-in]:translate-y-0 text-space-200 text-lg max-w-xl mx-auto mb-12 leading-relaxed">
        ...
        {/* Contact Cards */}
        <div className="reveal opacity-0 transition-all duration-700 delay-400 translate-y-8 [&.animate-in]:opacity-100 [&.animate-in]:translate-y-0 grid sm:grid-cols-2 gap-4 max-w-lg mx-auto mb-12">
          {/* GitHub */}
          <a
